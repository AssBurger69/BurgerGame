...
class Text(enum.Enum):
   ...
   mel_skill_text = 'Мел залил тебе блазуху в ухо!\n'
   redhead_name = 'Рыжий'
   ...
   glad_turbo_text = 'Твин-турбо гадза на минус уши\n'
   glad_church_text = 'Церковная целебная гадза\n'
   glad_cat_text = 'Кошачья критическая гадза\n'
   glad_elf_text = 'Эльфийская гадза с эффектом попускания\n'
   glad_poison_text = 'Ядовитая гадза по-киевски\n'
   glad_description = 'Владеет арсеналом фирменных гадз'
   shiva_name = 'Великая Шива'
   shiva_crit_buff_text = 'Криты завезли!\n'
   shiva_damage_buff_text = 'Урон завезли!\n'
   ...
   sick_sock_description = ' поймал твой носок лицом\n'
   ...
   madam_name = 'Мадам'
   madam_description = 'Мадам умиротворяет всех вокруг\n'